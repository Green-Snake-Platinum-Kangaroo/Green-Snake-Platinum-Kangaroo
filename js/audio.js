...
var analyser;
var buffer;
var url = 'sounds/cufool_you_in_my_world_instrumental.ogg';
var array = new Array();
var boost = 0;
		...
		function(buffer) {
			...
			$('#info')
				.fadeOut('normal', function() {
					$(this).html('<div id="artist"><a class="name" href="http://www.looperman.com/users/profile/345547" target="_blank">Cufool</a><br /><a class="song" href="http://www.looperman.com/tracks/detail/70506" target="_blank">You in my world instrumental</a><br /></div><div><img src="sounds/cufool.jpg" width="58" height="58" /></div>');
				})
				.fadeIn();
